...
export function Environment(name: string): BaseURL {
  return `https://${name}-my-app-xbai.encr.app`;
}
...
/**
 * Client is an API client for the my-app-xbai Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "my-app-xbai-Generated-TS-Client (Encore/v1.27.0)",
    };
